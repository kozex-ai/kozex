...
type TraceTag struct {
	...
	TagType TagType `thrift:"TagType,2,default,TagType" json:"tag_type" form:"TagType" query:"TagType"`
...
type FilterTag struct {
	...
	MultiTagKeys []string       `thrift:"MultiTagKeys,3,optional,list<string>" json:"multi_tag_keys" form:"MultiTagKeys" query:"MultiTagKeys"`
	Values       []string       `thrift:"Values,4,optional,list<string>" json:"values" form:"Values" query:"Values"`
	QueryType    *QueryTypeEnum `thrift:"QueryType,5,optional,QueryTypeEnum" json:"query_type" form:"QueryType" query:"QueryType"`
}
...
type ListRootSpansRequest struct {
	...
	Status          *SpanStatus `thrift:"Status,9,optional,SpanStatus" json:"status" form:"status" `
...
type Span struct {
	...
	Tags       []*TraceTag `thrift:"Tags,13,default,list<TraceTag>" json:"tags" form:"Tags" query:"Tags"`
}
...
type ListRootSpansResponse struct {
	Spans    []*Span        `thrift:"Spans,1,optional,list<Span>" json:"spans" form:"spans" `
...
type KeyScene struct {
	...
	// chat history
	HistoryMessages []*MessageItem `thrift:"HistoryMessages,4,optional,list<MessageItem>" json:"history_messages" form:"HistoryMessages" query:"HistoryMessages"`
	// input
	...
	// subscene
	SubKeyScenes []*KeyScene `thrift:"SubKeyScenes,9,optional,list<KeyScene>" json:"sub_key_scenes" form:"SubKeyScenes" query:"SubKeyScenes"`
}
...
type KeySceneInput struct {
	...
	ContentList []*TraceSummaryContent `thrift:"contentList,2,optional,list<TraceSummaryContent>" json:"content_list" form:"contentList" query:"contentList"`
}
...
type SpanSummary struct {
	Tags []*FrontendTag `thrift:"Tags,1,optional,list<FrontendTag>" json:"tags" form:"Tags" query:"Tags"`
}
...
type FrontendTag struct {
	...
	TagType  TagType `thrift:"TagType,3,required,TagType" json:"tag_type" form:"TagType,required" query:"TagType,required"`
	Value    *Value  `thrift:"Value,4,optional" json:"value" form:"Value" query:"Value"`
	// Front-end type for front-end processing
	FrontendTagType *FrontedTagType `thrift:"FrontendTagType,5,optional,FrontedTagType" json:"frontend_tag_type" form:"FrontendTagType" query:"FrontendTagType"`
	// Can it be copied?
...
type TraceSummary struct {
	...
	HistoryMessages []*MessageItem `thrift:"HistoryMessages,2,optional,list<MessageItem>" json:"history_messages" form:"HistoryMessages" query:"HistoryMessages"`
	KeyScenes       []*KeyScene    `thrift:"KeyScenes,3,optional,list<KeyScene>" json:"key_scenes" form:"KeyScenes" query:"KeyScenes"`
	// input
...
type TraceHeader struct {
	...
	Tags       []*FrontendTag `thrift:"Tags,4,optional,list<FrontendTag>" json:"tags" form:"Tags" query:"Tags"`
	// Message ID
...
type TraceFrontend struct {
	Spans  []*TraceFrontendSpan `thrift:"spans,1,optional,list<TraceFrontendSpan>" json:"spans" form:"spans" `
...
type SpanInputOutput struct {
	// TEXT
	Type    *InputOutputType `thrift:"Type,1,optional,InputOutputType" json:"type" form:"Type" query:"Type"`
	Content *string          `thrift:"Content,2,optional" json:"content" form:"Content" query:"Content"`
}
...
type TraceFrontendSpan struct {
	...
	Tags       []*TraceTag `thrift:"Tags,11,optional,list<TraceTag>" json:"tags" form:"Tags" query:"Tags"`
	// node details
	...
	OwnerList []string `thrift:"OwnerList,18,optional,list<string>" json:"owner_list" form:"OwnerList" query:"OwnerList"`
