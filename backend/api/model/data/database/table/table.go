...
type RefInfo struct {
	// reference type
	RefType RefType `thrift:"ref_type,1,default,RefType" form:"ref_type" json:"ref_type" query:"ref_type"`
	// reference id
...
type FieldItem struct {
	...
	Type         FieldItemType `thrift:"type,3,default,FieldItemType" form:"type" json:"type" query:"type"`
...
type OrderBy struct {
	...
	Direction SortDirection `thrift:"direction,2,default,SortDirection" form:"direction" json:"direction" query:"direction"`
}
...
type Criterion struct {
	Conditions      []*Condition `thrift:"conditions,1,default,list<Condition>" form:"conditions" json:"conditions" query:"conditions"`
...
type ListDatabaseRequest struct {
	...
	// Draft database
	TableType TableType `thrift:"table_type,6,required,TableType" form:"table_type,required" json:"table_type,required" query:"table_type,required"`
	// sort
	OrderBy []*OrderBy `thrift:"order_by,7,optional,list<OrderBy>" form:"order_by" json:"order_by,omitempty" query:"order_by"`
	...
	//sort condition
	OrderByList []*OrderBy `thrift:"order_by_list,11,optional,list<OrderBy>" form:"order_by_list" json:"order_by_list,omitempty" query:"order_by_list"`
...
type DatabaseInfo struct {
	...
	// status
	Status BotTableStatus `thrift:"status,9,default,BotTableStatus" form:"status" json:"status" query:"status"`
	// creator id
	...
	// Field information
	FieldList []*FieldItem `thrift:"field_list,13,default,list<FieldItem>" form:"field_list" json:"field_list" query:"field_list"`
	...
	// read and write mode
	RwMode BotTableRWMode `thrift:"rw_mode,15,default,BotTableRWMode" form:"rw_mode" json:"rw_mode" query:"rw_mode"`
...
type ListDatabaseResponse struct {
	DatabaseInfoList []*DatabaseInfo `thrift:"database_info_list,1,default,list<DatabaseInfo>" form:"database_info_list" json:"database_info_list" query:"database_info_list"`
...
type AddDatabaseRequest struct {
	...
	// Field information
	FieldList []*FieldItem `thrift:"field_list,7,default,list<FieldItem>" form:"field_list" json:"field_list" query:"field_list"`
	// Read and write mode, single user mode/multi-user mode
	RwMode BotTableRWMode `thrift:"rw_mode,8,default,BotTableRWMode" form:"rw_mode" json:"rw_mode" query:"rw_mode"`
	// Whether to support prompt calls
...
type UpdateDatabaseRequest struct {
	...
	// Field information
	FieldList []*FieldItem `thrift:"field_list,6,default,list<FieldItem>" form:"field_list" json:"field_list" query:"field_list"`
	// Read and write mode, single user mode/multi-user mode
	RwMode BotTableRWMode `thrift:"rw_mode,7,default,BotTableRWMode" form:"rw_mode" json:"rw_mode" query:"rw_mode"`
	// Whether to support prompt calls
...
type ListDatabaseRecordsRequest struct {
	...
	TableType TableType `thrift:"table_type,6,default,TableType" form:"table_type" json:"table_type" query:"table_type"`
...
type ListDatabaseRecordsRequestRPC struct {
	...
	DatabaseID int64 `thrift:"database_id,1,required" form:"database_id,required" json:"database_id,string,required" query:"database_id,required"`
	// Do you want to check the draft state or the online state?
	TableType TableType `thrift:"table_type,2,default,TableType" form:"table_type" json:"table_type" query:"table_type"`
	// Do not exceed 100, 50 is recommended.
...
type ListDatabaseRecordsResponseRPC struct {
	Data     []map[string]string `thrift:"data,1,required,list<map<string:string>>" form:"data,required" json:"data,required" query:"data,required"`
	...
	// Field information
	FieldList []*FieldItem   `thrift:"field_list,4,default,list<FieldItem>" form:"field_list" json:"field_list" query:"field_list"`
	BaseResp  *base.BaseResp `thrift:"BaseResp,255,required" form:"BaseResp,required" json:"BaseResp,required" query:"BaseResp,required"`
}
...
type ListDatabaseRecordsResponse struct {
	...
	TotalNum int32               `thrift:"TotalNum,3,required" form:"TotalNum,required" json:"TotalNum,required" query:"TotalNum,required"`
	// Field information
	FieldList []*FieldItem   `thrift:"field_list,4,optional,list<FieldItem>" form:"field_list" json:"field_list,omitempty" query:"field_list"`
	Code      int64          `thrift:"code,253,required" form:"code,required" json:"code,required" query:"code,required"`
	Msg       string         `thrift:"msg,254,required" form:"msg,required" json:"msg,required" query:"msg,required"`
	BaseResp  *base.BaseResp `thrift:"BaseResp,255,required" form:"BaseResp,required" json:"BaseResp,required" query:"BaseResp,required"`
}
...
type UpdateDatabaseRecordsRequest struct {
	...
	DatabaseID int64 `thrift:"database_id,1,required" form:"database_id,required" json:"database_id,string,required" query:"database_id,required"`
	// new
	RecordDataAdd []map[string]string `thrift:"record_data_add,2,optional,list<map<string:string>>" form:"record_data_add" json:"record_data_add,omitempty" query:"record_data_add"`
	// modified
	RecordDataAlter []map[string]string `thrift:"record_data_alter,3,optional,list<map<string:string>>" form:"record_data_alter" json:"record_data_alter,omitempty" query:"record_data_alter"`
	// deleted
	RecordDataDelete []map[string]string `thrift:"record_data_delete,4,optional,list<map<string:string>>" form:"record_data_delete" json:"record_data_delete,omitempty" query:"record_data_delete"`
	// Is the draft state or online state to be updated?
	TableType *TableType `thrift:"table_type,5,optional,TableType" form:"table_type" json:"table_type,omitempty" query:"table_type"`
...
type BotTable struct {
	...
	TableDesc string `thrift:"table_desc,5" form:"table_desc" json:"table_desc" query:"table_desc"`
	// status
	Status BotTableStatus `thrift:"status,6,default,BotTableStatus" form:"status" json:"status" query:"status"`
	// Creating the ID.
	...
	// Field information
	FieldList []*FieldItem `thrift:"field_list,10,default,list<FieldItem>" form:"field_list" json:"field_list" query:"field_list"`
	// Data table actual name
	ActualTableName string `thrift:"actual_table_name,11" form:"actual_table_name" json:"actual_table_name" query:"actual_table_name"`
	// read and write mode
	RwMode BotTableRWMode `thrift:"rw_mode,12,default,BotTableRWMode" form:"rw_mode" json:"rw_mode" query:"rw_mode"`
	// extended information
...
type GetBotTableRequest struct {
	...
	BotID     *int64     `thrift:"bot_id,2,optional" form:"bot_id" json:"bot_id,string,omitempty" query:"bot_id"`
	TableIds  []int64    `thrift:"table_ids,3,optional,list<i64>" form:"table_ids" json:"table_ids,string,omitempty" query:"table_ids"`
	TableType TableType  `thrift:"table_type,4,required,TableType" form:"table_type,required" json:"table_type,required" query:"table_type,required"`
	Base      *base.Base `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
type GetBotTableResponse struct {
	BotTableList []*BotTable    `thrift:"BotTableList,1,default,list<BotTable>" form:"BotTableList" json:"BotTableList" query:"BotTableList"`
	Code         int64          `thrift:"code,253,required" form:"code,required" json:"code,required" query:"code,required"`
	Msg          string         `thrift:"msg,254,required" form:"msg,required" json:"msg,required" query:"msg,required"`
	BaseResp     *base.BaseResp `thrift:"BaseResp,255,required" form:"BaseResp,required" json:"BaseResp,required" query:"BaseResp,required"`
}
...
type CopyDatabaseRequest struct {
	...
	//Original tableId
	TableIds  []int64    `thrift:"TableIds,2,required,list<i64>" form:"TableIds,required" json:"TableIds,required" query:"TableIds,required"`
...
type GetNL2SQLRequest struct {
	...
	TableType TableType `thrift:"table_type,5,required,TableType" form:"table_type,required" json:"table_type,required" query:"table_type,required"`
	// Database ID
...
type BatchInsertBotTableInfoRequest struct {
	...
	// save data
	Data []map[string]string `thrift:"data,3,default,list<map<string:string>>" form:"data" json:"data" query:"data"`
	// user id
...
type UpdateBotTableInfoRequest struct {
	...
	CollectionName string `thrift:"collection_name,2" form:"collection_name" json:"collection_name" query:"collection_name"`
	// update data
	DataList []map[string]string `thrift:"data_list,3,default,list<map<string:string>>" form:"data_list" json:"data_list" query:"data_list"`
	// user id
	UserID int64 `thrift:"user_id,4" form:"user_id" json:"user_id" query:"user_id"`
	// bot id
	BotID int64      `thrift:"bot_id,5" form:"bot_id" json:"bot_id" query:"bot_id"`
...
type DeleteBotTableInfoRequest struct {
	...
	CollectionName string `thrift:"collection_name,2" form:"collection_name" json:"collection_name" query:"collection_name"`
	// Delete id list
	Ids []string `thrift:"ids,3,default,list<string>" form:"ids" json:"ids" query:"ids"`
	// user id
	UserID int64 `thrift:"user_id,4" form:"user_id" json:"user_id" query:"user_id"`
	// bot id
	BotID int64      `thrift:"bot_id,5" form:"bot_id" json:"bot_id" query:"bot_id"`
...
type ExecuteSqlRequest struct {
	...
	ConnectorUID string `thrift:"connector_uid,4" form:"connector_uid" json:"connector_uid" query:"connector_uid"`
	// Table type
	TableType TableType `thrift:"table_type,5,default,TableType" form:"table_type" json:"table_type" query:"table_type"`
	...
	// SQL params
	SqlParams []*SqlParamVal `thrift:"SqlParams,8,optional,list<SqlParamVal>" form:"SqlParams" json:"SqlParams,omitempty" query:"SqlParams"`
	// Database info id
...
type SqlParamVal struct {
	ValueType FieldItemType `thrift:"ValueType,1,required,FieldItemType" json:"value_type" form:"ValueType,required" query:"ValueType,required"`
...
type RecommendDataModelRequest struct {
	...
	SceneType SceneType  `thrift:"scene_type,2,required,SceneType" form:"scene_type,required" json:"scene_type,required" query:"scene_type,required"`
...
type MigrateOldDataRequest struct {
	...
	BotType TableType `thrift:"bot_type,1,default,TableType" form:"bot_type" json:"bot_type" query:"bot_type"`
	// Which bot to migrate?
	BotID int64 `thrift:"bot_id,2" form:"bot_id" json:"bot_id,string" query:"bot_id"`
	// Failed retry
	TableIds []int64    `thrift:"table_ids,3,default,list<i64>" form:"table_ids" json:"table_ids,string" query:"table_ids"`
	Base     *base.Base `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
type MGetDisplayResourceInfoRequest struct {
	...
	ResIDs []int64 `thrift:"ResIDs,1,default,list<i64>" form:"ResIDs" json:"ResIDs" query:"ResIDs"`
...
type MGetDisplayResourceInfoResponse struct {
	ResourceList []*DisplayResourceInfo `thrift:"ResourceList,1,default,list<DisplayResourceInfo>" form:"ResourceList" json:"ResourceList" query:"ResourceList"`
	BaseResp     *base.BaseResp         `thrift:"BaseResp,255,required" form:"BaseResp,required" json:"BaseResp,required" query:"BaseResp,required"`
}
...
type ResourceAction struct {
	...
	Key ActionKey `thrift:"Key,1,required,ActionKey" json:"key" form:"Key,required" query:"Key,required"`
...
type DisplayResourceInfo struct {
	...
	Actions []*ResourceAction `thrift:"Actions,17,optional,list<ResourceAction>" form:"Actions" json:"Actions,omitempty" query:"Actions"`
	...
	PublishStatus *PublishStatus `thrift:"PublishStatus,20,optional,PublishStatus" form:"PublishStatus" json:"PublishStatus,omitempty" query:"PublishStatus"`
...
type SelectFieldList struct {
	FieldID    []string `thrift:"FieldID,1,required,list<string>" form:"FieldID,required" json:"FieldID,required" query:"FieldID,required"`
...
type Condition struct {
	...
	Operation Operation `thrift:"operation,2,required,Operation" form:"operation,required" json:"operation,required" query:"operation,required"`
	// rvalue
...
type ComplexCondition struct {
	Conditions []*Condition `thrift:"conditions,1,optional,list<Condition>" form:"conditions" json:"conditions,omitempty" query:"conditions"`
...
type Row struct {
	Values []*UpsertValues `thrift:"values,1,default,list<UpsertValues>" form:"values" json:"values" query:"values"`
}
...
type CRUDDatabaseRequest struct {
	...
	// Table type
	TableType TableType `thrift:"table_type,7,required,TableType" form:"table_type,required" json:"table_type,required" query:"table_type,required"`
	// Workflow test run identification
	WftestID string `thrift:"wftest_id,8" form:"wftest_id" json:"wftest_id" query:"wftest_id"`
	// citation information
	RefInfo *RefInfo `thrift:"ref_info,9,optional" form:"ref_info" json:"ref_info,omitempty" query:"ref_info"`
	// SQL params
	SQLParams []*SqlParamVal `thrift:"sql_params,10,optional,list<SqlParamVal>" form:"sql_params" json:"sql_params,omitempty" query:"sql_params"`
	// operation type
	OperateType OperateType `thrift:"operate_type,11,required,OperateType" form:"operate_type,required" json:"operate_type,required" query:"operate_type,required"`
	...
	// Order by field list
	OrderByList []*OrderBy `thrift:"order_by_list,13,optional,list<OrderBy>" form:"order_by_list" json:"order_by_list,omitempty" query:"order_by_list"`
	// limit
	...
	// Data to upsert
	Rows []*Row `thrift:"rows,17,optional,list<Row>" form:"rows" json:"rows,omitempty" query:"rows"`
}
...
type GetTableSchemaRequest struct {
	...
	TableDataType *TableDataType `thrift:"table_data_type,2,optional,TableDataType" form:"table_data_type" json:"table_data_type,omitempty" query:"table_data_type"`
...
type TableColumn struct {
	...
	// column type
	ColumnType         *ColumnType `thrift:"column_type,4,optional,ColumnType" form:"column_type" json:"column_type,omitempty" query:"column_type"`
...
type GetDatabaseFileProgressRequest struct {
	DatabaseID int64 `thrift:"database_id,1" form:"database_id" json:"database_id,string" query:"database_id"`
	// Table type
	TableType TableType  `thrift:"table_type,2,required,TableType" form:"table_type,required" json:"table_type,required" query:"table_type,required"`
	Base      *base.Base `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
type SubmitDatabaseInsertRequest struct {
	...
	TableType  TableType   `thrift:"table_type,3,default,TableType" form:"table_type" json:"table_type" query:"table_type"`
...
type GetSpaceConnectorListResponse struct {
	ConnectorList []*ConnectorInfo `thrift:"ConnectorList,1,default,list<ConnectorInfo>" form:"ConnectorList" json:"ConnectorList" query:"ConnectorList"`
	Code          int64            `thrift:"code,253,required" form:"code,required" json:"code,required" query:"code,required"`
	Msg           string           `thrift:"msg,254,required" form:"msg,required" json:"msg,required" query:"msg,required"`
	BaseResp      *base.BaseResp   `thrift:"BaseResp,255,optional" form:"BaseResp" json:"BaseResp,omitempty" query:"BaseResp"`
}
