...
type VariableInfo struct {
	...
	EffectiveChannelList []string `thrift:"EffectiveChannelList,12,optional,list<string>" form:"EffectiveChannelList" json:"EffectiveChannelList,omitempty" query:"EffectiveChannelList"`
}
...
type GroupVariableInfo struct {
	...
	VarInfoList  []*VariableInfo      `thrift:"var_info_list,4,default,list<VariableInfo>" form:"var_info_list" json:"var_info_list" query:"var_info_list"`
	SubGroupInfo []*GroupVariableInfo `thrift:"sub_group_info,5,default,list<GroupVariableInfo>" form:"sub_group_info" json:"sub_group_info" query:"sub_group_info"`
}
...
type SetKvMemoryReq struct {
	...
	Data        []*KVItem `thrift:"data,3,required,list<KVItem>" form:"data,required" json:"data,required" query:"data,required"`
...
type GetSysVariableConfResponse struct {
	Conf      []*VariableInfo      `thrift:"conf,1,default,list<VariableInfo>" form:"conf" json:"conf" query:"conf"`
	GroupConf []*GroupVariableInfo `thrift:"group_conf,2,default,list<GroupVariableInfo>" form:"group_conf" json:"group_conf" query:"group_conf"`
	Code      int64                `thrift:"code,253,required" form:"code,required" json:"code,required" query:"code,required"`
	Msg       string               `thrift:"msg,254,required" form:"msg,required" json:"msg,required" query:"msg,required"`
...
type DelProfileMemoryRequest struct {
	...
	Keywords    []string `thrift:"keywords,3,default,list<string>" form:"keywords" json:"keywords" query:"keywords"`
	ConnectorID *int64   `thrift:"connector_id,4,optional" form:"connector_id" json:"connector_id,omitempty" query:"connector_id"`
	// citation information
	RefInfo   *table.RefInfo `thrift:"ref_info,5,optional" form:"ref_info" json:"ref_info,omitempty" query:"ref_info"`
...
type GetProfileMemoryRequest struct {
	...
	VariableChannel *project_memory.VariableChannel `thrift:"VariableChannel,10,optional,VariableChannel" form:"VariableChannel" json:"VariableChannel,omitempty" query:"VariableChannel"`
	Base            *base.Base                      `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
type GetProfileMemoryResponse struct {
	Memories []*KVItem      `thrift:"memories,1,default,list<KVItem>" form:"memories" json:"memories" query:"memories"`
	Code     int64          `thrift:"code,253,required" form:"code,required" json:"code,required" query:"code,required"`
	Msg      string         `thrift:"msg,254,required" form:"msg,required" json:"msg,required" query:"msg,required"`
	BaseResp *base.BaseResp `thrift:"BaseResp,255,required" form:"BaseResp,required" json:"BaseResp,required" query:"BaseResp,required"`
}
