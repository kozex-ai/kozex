...
type Variable struct {
	...
	VariableType VariableType    `thrift:"VariableType,3,default,VariableType" form:"VariableType" json:"VariableType" query:"VariableType"`
	Channel      VariableChannel `thrift:"Channel,4,default,VariableChannel" form:"Channel" json:"Channel" query:"Channel"`
	...
	//effective channel
	EffectiveChannelList []string `thrift:"EffectiveChannelList,7,optional,list<string>" form:"EffectiveChannelList" json:"EffectiveChannelList,omitempty" query:"EffectiveChannelList"`
...
type GroupVariableInfo struct {
	...
	VarInfoList    []*Variable          `thrift:"VarInfoList,4,default,list<Variable>" form:"VarInfoList" json:"VarInfoList" query:"VarInfoList"`
	SubGroupList   []*GroupVariableInfo `thrift:"SubGroupList,5,default,list<GroupVariableInfo>" form:"SubGroupList" json:"SubGroupList" query:"SubGroupList"`
	IsReadOnly     bool                 `thrift:"IsReadOnly,6" form:"IsReadOnly" json:"IsReadOnly" query:"IsReadOnly"`
	DefaultChannel *VariableChannel     `thrift:"DefaultChannel,7,optional,VariableChannel" form:"DefaultChannel" json:"DefaultChannel,omitempty" query:"DefaultChannel"`
}
...
type GetProjectVariableListResp struct {
	VariableList []*Variable          `thrift:"VariableList,1,default,list<Variable>" form:"VariableList" json:"VariableList" query:"VariableList"`
	CanEdit      bool                 `thrift:"CanEdit,2" form:"CanEdit" json:"CanEdit" query:"CanEdit"`
	GroupConf    []*GroupVariableInfo `thrift:"GroupConf,3,default,list<GroupVariableInfo>" form:"GroupConf" json:"GroupConf" query:"GroupConf"`
...
type UpdateProjectVariableReq struct {
	ProjectID    string      `thrift:"ProjectID,1" form:"ProjectID" json:"ProjectID" query:"ProjectID"`
	UserID       int64       `thrift:"UserID,2" form:"UserID" json:"UserID" query:"UserID"`
	VariableList []*Variable `thrift:"VariableList,3,default,list<Variable>" form:"VariableList" json:"VariableList" query:"VariableList"`
	Base         *base.Base  `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
type GetMemoryVariableMetaReq struct {
	...
	ConnectorType VariableConnector `thrift:"ConnectorType,2,default,VariableConnector" form:"ConnectorType" json:"ConnectorType" query:"ConnectorType"`
...
type GetMemoryVariableMetaResp struct {
	VariableMap map[VariableChannel][]*Variable `thrift:"VariableMap,1,default,map<VariableChannel:list<Variable>>" form:"VariableMap" json:"VariableMap" query:"VariableMap"`
	Code        int64                           `thrift:"code,253,required" form:"code,required" json:"code,required" query:"code,required"`
	Msg         string                          `thrift:"msg,254,required" form:"msg,required" json:"msg,required" query:"msg,required"`
	BaseResp    *base.BaseResp                  `thrift:"BaseResp,255,required" form:"BaseResp,required" json:"BaseResp,required" query:"BaseResp,required"`
}
