...
type Review struct {
	...
	// status
	Status        *ReviewStatus `thrift:"status,5,optional,ReviewStatus" form:"status" json:"status,omitempty" query:"status"`
...
type CreateDocumentReviewRequest struct {
	...
	Reviews         []*ReviewInput   `thrift:"reviews,2,default,list<ReviewInput>" form:"reviews" json:"reviews" query:"reviews"`
...
type CreateDocumentReviewResponse struct {
	DatasetID int64          `thrift:"dataset_id,1" form:"dataset_id" json:"dataset_id,string" query:"dataset_id"`
	Reviews   []*Review      `thrift:"reviews,2,default,list<Review>" form:"reviews" json:"reviews" query:"reviews"`
...
type MGetDocumentReviewRequest struct {
	DatasetID int64      `thrift:"dataset_id,1" form:"dataset_id" json:"dataset_id,string" query:"dataset_id"`
	ReviewIds []string   `thrift:"review_ids,2,default,list<string>" form:"review_ids" json:"review_ids" query:"review_ids"`
	Base      *base.Base `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
}
