...
type DeleteSliceRequest struct {
	...
	SliceIds []string   `thrift:"slice_ids,4,optional,list<string>" form:"slice_ids" json:"slice_ids,omitempty"`
...
type ListSliceResponse struct {
	...
	Slices []*SliceInfo `thrift:"slices,1,default,list<SliceInfo>" form:"slices" json:"slices" query:"slices"`
	// Total shardings
...
type SliceInfo struct {
	...
	// Sharding state
	Status SliceStatus `thrift:"status,3,default,SliceStatus" form:"status" json:"status" query:"status"`
	// hit count
