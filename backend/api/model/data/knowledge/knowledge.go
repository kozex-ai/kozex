...
type CreateDatasetRequest struct {
	...
	FormatType FormatType `thrift:"format_type,5,default,FormatType" form:"format_type" json:"format_type" query:"format_type"`
...
type DatasetDetailRequest struct {
	DatasetIDs []string `thrift:"DatasetIDs,1,default,list<string>" form:"dataset_ids" json:"dataset_ids"`
	// project ID
...
type ListDatasetRequest struct {
	...
	// sort field
	OrderField *OrderField `thrift:"order_field,6,optional,OrderField" form:"order_field" json:"order_field,omitempty" query:"order_field"`
	// order_type
	OrderType *OrderType `thrift:"order_type,7,optional,OrderType" form:"order_type" json:"order_type,omitempty" query:"order_type"`
...
type ListDatasetResponse struct {
	DatasetList []*Dataset     `thrift:"dataset_list,1,default,list<Dataset>" form:"dataset_list" json:"dataset_list" query:"dataset_list"`
...
type DatasetFilter struct {
	...
	// Knowledge id list
	DatasetIds []string `thrift:"dataset_ids,2,optional,list<string>" form:"dataset_ids" json:"dataset_ids,omitempty" query:"dataset_ids"`
	// source
	SourceType *DatasetSource `thrift:"source_type,3,optional,DatasetSource" form:"source_type" json:"source_type,omitempty" query:"source_type"`
	// search type
	ScopeType *DatasetScopeType `thrift:"scope_type,4,optional,DatasetScopeType" form:"scope_type" json:"scope_type,omitempty" query:"scope_type"`
	// type
	FormatType *FormatType `thrift:"format_type,5,optional,FormatType" form:"format_type" json:"format_type,omitempty" query:"format_type"`
}
...
type UpdateDatasetRequest struct {
	...
	Status      *DatasetStatus `thrift:"status,5,optional,DatasetStatus" form:"status" json:"status,omitempty" query:"status"`
	Base        *base.Base     `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
type GetIconRequest struct {
	FormatType FormatType `thrift:"format_type,1,default,FormatType" form:"format_type" json:"format_type" query:"format_type"`
}
...
type CreateDatasetOpenApiRequest struct {
	...
	FormatType  FormatType `thrift:"format_type,5,default,FormatType" form:"format_type" json:"format_type"`
...
type ListDatasetOpenApiRequest struct {
	...
	// Type
	FormatType *FormatType `thrift:"format_type,2,optional,FormatType" json:"format_type,omitempty" query:"format_type"`
...
type ListDatasetOpenApiData struct {
	DatasetList []*Dataset `thrift:"dataset_list,1,default,list<Dataset>" form:"dataset_list" json:"dataset_list"`
...
type ListPhotoOpenApiData struct {
	PhotoInfos []*PhotoInfo `thrift:"photo_infos,1,default,list<PhotoInfo>" form:"photo_infos" json:"photo_infos"`
	TotalCount int32        `thrift:"total_count,2" form:"total_count" json:"total_count"`
}
...
type GetDocumentProgressOpenApiRequest struct {
	DocumentIds []int64    `thrift:"document_ids,1,default,list<i64>" form:"document_ids" json:"document_ids,string"`
...
type GetDocumentProgressOpenApiData struct {
	Data []*DocumentProgress `thrift:"data,1,default,list<DocumentProgress>" form:"data" json:"data"`
}
