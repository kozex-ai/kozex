...
type ListDocumentRequest struct {
	...
	DocumentIds []string `thrift:"document_ids,2,optional,list<string>" form:"document_ids" json:"document_ids,omitempty" query:"document_ids"`
...
type ListDocumentResponse struct {
	DocumentInfos []*DocumentInfo `thrift:"document_infos,1,default,list<DocumentInfo>" form:"document_infos" json:"document_infos" query:"document_infos"`
...
type DocumentInfo struct {
	...
	// status
	Status DocumentStatus `thrift:"status,12,default,DocumentStatus" form:"status" json:"status" query:"status"`
	// hit count
	HitCount int32 `thrift:"hit_count,13" form:"hit_count" json:"hit_count" query:"hit_count"`
	// source
	SourceType DocumentSource `thrift:"source_type,14,default,DocumentSource" form:"source_type" json:"source_type" query:"source_type"`
	// file type
	FormatType FormatType `thrift:"format_type,18,default,FormatType" form:"format_type" json:"format_type" query:"format_type"`
	// Table type metadata
	TableMeta []*TableColumn `thrift:"table_meta,19,optional,list<TableColumn>" form:"table_meta" json:"table_meta,omitempty" query:"table_meta"`
	// URL address
...
type TableColumn struct {
	...
	// column type
	ColumnType         *ColumnType `thrift:"column_type,5,optional,ColumnType" form:"column_type" json:"column_type,omitempty" query:"column_type"`
...
type DeleteDocumentRequest struct {
	...
	DocumentIds []string   `thrift:"document_ids,2,default,list<string>" form:"document_ids" json:"document_ids" query:"document_ids"`
	Base        *base.Base `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
type UpdateDocumentRequest struct {
	...
	TableMeta []*TableColumn `thrift:"table_meta,5,optional,list<TableColumn>" form:"table_meta" json:"table_meta,omitempty" query:"table_meta"`
	Base      *base.Base     `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
type PhotoFilter struct {
	...
	// status
	Status *DocumentStatus `thrift:"status,3,optional,DocumentStatus" form:"status" json:"status,omitempty" query:"status"`
}
...
type ListPhotoResponse struct {
	PhotoInfos []*PhotoInfo   `thrift:"photo_infos,1,default,list<PhotoInfo>" form:"photo_infos" json:"photo_infos" query:"photo_infos"`
	Total      int32          `thrift:"total,2" form:"total" json:"total" query:"total"`
	Code       int64          `thrift:"code,253,required" form:"code,required" json:"code,required" query:"code,required"`
	Msg        string         `thrift:"msg,254,required" form:"msg,required" json:"msg,required" query:"msg,required"`
	BaseResp   *base.BaseResp `thrift:"BaseResp,255,required" form:"-" json:"-" query:"-"`
...
type PhotoDetailRequest struct {
	// Document ID List
	DocumentIds []string `thrift:"document_ids,1,required,list<string>" form:"document_ids,required" json:"document_ids,required" query:"document_ids,required"`
	// Knowledge ID
...
type CreateDocumentRequest struct {
	...
	FormatType FormatType `thrift:"format_type,4,default,FormatType" form:"format_type" json:"format_type" query:"format_type"`
	// Only one table type can be created at a time
	DocumentBases []*DocumentBase `thrift:"document_bases,6,default,list<DocumentBase>" form:"document_bases" json:"document_bases" query:"document_bases"`
...
type CreateDocumentResponse struct {
	DocumentInfos []*DocumentInfo `thrift:"document_infos,2,default,list<DocumentInfo>" form:"document_infos" json:"document_infos" query:"document_infos"`
...
type DocumentBase struct {
	...
	TableMeta []*TableColumn `thrift:"table_meta,4,optional,list<TableColumn>" form:"table_meta" json:"table_meta,omitempty" query:"table_meta"`
...
type SourceInfo struct {
	...
	DocumentSource *DocumentSource `thrift:"document_source,4,optional,DocumentSource" form:"document_source" json:"document_source,omitempty"`
...
type GetDocumentProgressRequest struct {
	DocumentIds []string   `thrift:"document_ids,1,default,list<string>" form:"document_ids" json:"document_ids" query:"document_ids"`
	Base        *base.Base `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
type GetDocumentProgressResponse struct {
	Data     []*DocumentProgress `thrift:"data,1,default,list<DocumentProgress>" form:"data" json:"data" query:"data"`
	Code     int64               `thrift:"code,253,required" form:"code,required" json:"code,required" query:"code,required"`
	Msg      string              `thrift:"msg,254,required" form:"msg,required" json:"msg,required" query:"msg,required"`
	BaseResp *base.BaseResp      `thrift:"BaseResp,255,optional" form:"BaseResp" json:"BaseResp,omitempty" query:"BaseResp"`
}
...
type GetTableSchemaRequest struct {
	...
	OriginTableMeta []*TableColumn `thrift:"origin_table_meta,5,optional,list<TableColumn>" form:"origin_table_meta" json:"origin_table_meta,omitempty" query:"origin_table_meta"`
	// The table preview front end needs to pass the data table structure edited by the user
	PreviewTableMeta []*TableColumn `thrift:"preview_table_meta,6,optional,list<TableColumn>" form:"preview_table_meta" json:"preview_table_meta,omitempty" query:"preview_table_meta"`
	Base             *base.Base     `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
type GetTableSchemaResponse struct {
	...
	SheetList []*DocTableSheet `thrift:"sheet_list,3,default,list<DocTableSheet>" form:"sheet_list" json:"sheet_list" query:"sheet_list"`
	// The schema of the selected sheet, not selected to return the first sheet by default
	TableMeta []*TableColumn `thrift:"table_meta,4,default,list<TableColumn>" form:"table_meta" json:"table_meta" query:"table_meta"`
	// The knowledge table will return
	PreviewData []map[string]string `thrift:"preview_data,5,default,list<map<string:string>>" form:"preview_data" json:"preview_data"`
...
type GetDocumentTableInfoResponse struct {
	...
	TableMeta map[string][]*DocTableColumn `thrift:"table_meta,4,default,map<string:list<DocTableColumn>>" form:"table_meta" json:"table_meta"`
	// key: sheet_id -> list_preview_data
	PreviewData map[string][]map[string]string `thrift:"preview_data,5,default,map<string:list<map<string:string>>>" form:"preview_data" json:"preview_data"`
	BaseResp    *base.BaseResp                 `thrift:"BaseResp,255,required" form:"-" json:"-" query:"-"`
}
...
type GetTableSchemaInfoResponse struct {
	...
	SheetList []*DocTableSheet `thrift:"sheet_list,3,default,list<DocTableSheet>" form:"sheet_list" json:"sheet_list" query:"sheet_list"`
	// The schema of the selected sheet, not selected to return the first sheet by default
	TableMeta []*DocTableColumn `thrift:"table_meta,4,default,list<DocTableColumn>" form:"table_meta" json:"table_meta" query:"table_meta"`
	// The knowledge table will return
	PreviewData []map[int64]string `thrift:"preview_data,5,default,list<map<i64:string>>" form:"preview_data" json:"preview_data" query:"preview_data"`
	BaseResp    *base.BaseResp     `thrift:"BaseResp,255,optional" form:"-" json:"-" query:"-"`
}
