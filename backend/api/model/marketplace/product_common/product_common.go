...
type CommercialSetting struct {
	CommercialType ProductPaidType `thrift:"commercial_type,1,required,ProductPaidType" form:"commercial_type,required" json:"commercial_type,required"`
}
...
type UserInfo struct {
	...
	FollowType *marketplace_common.FollowType `thrift:"follow_type,6,optional,FollowType" form:"follow_type" json:"follow_type,omitempty"`
}
...
type FavoriteEntity struct {
	...
	EntityType  ProductEntityType `thrift:"EntityType,2,default,ProductEntityType" form:"entity_type" json:"entity_type"`
...
type FavoriteProductExtra struct {
	...
	ProductStatus ProductStatus `thrift:"ProductStatus,2,default,ProductStatus" form:"product_status" json:"product_status"`
}
...
type FavoritePluginExtra struct {
	Tools []*PluginTool `thrift:"Tools,1,default,list<PluginTool>" form:"tools" json:"tools"`
}
