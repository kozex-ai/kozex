...
type SearchProductRequest struct {
	...
	EntityType *product_common.ProductEntityType `thrift:"EntityType,4,optional,ProductEntityType" form:"EntityType" json:"EntityType,omitempty" query:"EntityType"`
	SortType   *product_common.SortType          `thrift:"SortType,5,optional,SortType" json:"SortType,omitempty" query:"sort_type"`
	// Open/closed source
	PublishMode *product_common.ProductPublishMode `thrift:"PublishMode,11,optional,ProductPublishMode" form:"PublishMode" json:"PublishMode,omitempty" query:"PublishMode"`
	// Models used
	ModelIDs []int64 `thrift:"ModelIDs,12,optional,list<i64>" json:"ModelIDs,omitempty" query:"model_ids"`
	// Multimodal type
	BotModType *product_common.BotModType `thrift:"BotModType,13,optional,BotModType" form:"BotModType" json:"BotModType,omitempty" query:"BotModType"`
	// Sub-attributes
	Components []product_common.Component `thrift:"Components,14,optional,list<Component>" form:"Components" json:"Components,omitempty" query:"Components"`
	// Publish platform IDs
	PublishPlatformIDs []int64 `thrift:"PublishPlatformIDs,15,optional,list<i64>" json:"PublishPlatformIDs,omitempty" query:"publish_platform_ids"`
	// Product category IDs
	CategoryIDs []int64 `thrift:"CategoryIDs,16,optional,list<i64>" json:"CategoryIDs,omitempty" query:"category_ids"`
	// Is official
	...
	// Plugin type
	PluginType *product_common.PluginType `thrift:"PluginType,20,optional,PluginType" form:"PluginType" json:"PluginType,omitempty" query:"PluginType"`
	// Product paid type
	ProductPaidType *product_common.ProductPaidType `thrift:"ProductPaidType,21,optional,ProductPaidType" form:"ProductPaidType" json:"ProductPaidType,omitempty" query:"ProductPaidType"`
...
type SearchProductResponseData struct {
	Products []*ProductInfo `thrift:"Products,1,optional,list<ProductInfo>" form:"products" json:"products,omitempty"`
	...
	// Entity count
	EntityTotal map[product_common.ProductEntityType]int32 `thrift:"EntityTotal,4,optional,map<ProductEntityType:i32>" form:"entity_total" json:"entity_total,omitempty"`
}
...
type SearchSuggestResponseData struct {
	// Deprecated
	Suggestions  []*ProductMetaInfo `thrift:"Suggestions,1,optional,list<ProductMetaInfo>" form:"suggestions" json:"suggestions,omitempty"`
	HasMore      *bool              `thrift:"HasMore,2,optional" form:"has_more" json:"has_more,omitempty"`
	SuggestionV2 []*ProductInfo     `thrift:"SuggestionV2,3,optional,list<ProductInfo>" form:"suggestion_v2" json:"suggestion_v2,omitempty"`
}
...
type SearchSuggestRequest struct {
	...
	EntityType *product_common.ProductEntityType `thrift:"EntityType,2,optional,ProductEntityType" json:"EntityType,omitempty" query:"entity_type"`
...
type FavoriteProductRequest struct {
	...
	EntityType product_common.ProductEntityType `thrift:"EntityType,2,required,ProductEntityType" form:"entity_type,required" json:"entity_type,required"`
...
type GetProductListRequest struct {
	EntityType *product_common.ProductEntityType `thrift:"EntityType,1,optional,ProductEntityType" form:"entity_type" json:"entity_type,omitempty"`
	CategoryID *int64                            `thrift:"CategoryID,2,optional" json:"CategoryID,string,omitempty" query:"category_id"`
	SortType   product_common.SortType           `thrift:"SortType,3,required,SortType" form:"sort_type,required" json:"sort_type,required"`
	...
	PublishMode *product_common.ProductPublishMode `thrift:"PublishMode,7,optional,ProductPublishMode" form:"publish_mode" json:"publish_mode,omitempty"`
	// publish platforms
	PublishPlatformIDs []int64 `thrift:"PublishPlatformIDs,8,optional,list<i64>" form:"PublishPlatformIDs" json:"PublishPlatformIDs,string,omitempty" query:"PublishPlatformIDs"`
	// List tab; 1 - Operational recommendations
	Source *product_common.ProductListSource `thrift:"Source,9,optional,ProductListSource" form:"source" json:"source,omitempty"`
	// Personalized recommendation scenarios, enter current entity information, and obtain recommended products
	CurrentEntityType *product_common.ProductEntityType `thrift:"CurrentEntityType,10,optional,ProductEntityType" form:"current_entity_type" json:"current_entity_type,omitempty"`
	// Current entity ID
	...
	EntityTypes []product_common.ProductEntityType `thrift:"EntityTypes,17,optional,list<ProductEntityType>" form:"entity_types" json:"entity_types,omitempty"`
	...
	// plugin type
	PluginType *product_common.PluginType `thrift:"PluginType,19,optional,PluginType" form:"plugin_type" json:"plugin_type,omitempty"`
...
type ProductMetaInfo struct {
	...
	EntityType product_common.ProductEntityType `thrift:"EntityType,4,default,ProductEntityType" form:"entity_type" json:"entity_type"`
	...
	Status      product_common.ProductStatus `thrift:"Status,11,default,ProductStatus" form:"status" json:"status"`
	...
	Labels        []*ProductLabel          `thrift:"Labels,17,optional,list<ProductLabel>" form:"labels" json:"labels,omitempty"`
	...
	// Template cover
	Covers []*product_common.ImageInfo `thrift:"Covers,21,optional,list<product_common.ImageInfo>" form:"covers" json:"covers,omitempty"`
...
type PluginExtraInfo struct {
	Tools         []*PluginToolInfo `thrift:"Tools,1,optional,list<PluginToolInfo>" form:"tools" json:"tools,omitempty"`
	...
	Connectors    []*PluginConnectorInfo     `thrift:"Connectors,15,default,list<PluginConnectorInfo>" form:"connectors" json:"connectors"`
	PluginType    *product_common.PluginType `thrift:"PluginType,16,optional,PluginType" form:"plugin_type" json:"plugin_type,omitempty"`
	// for opencoze
	AuthMode    *PluginAuthMode `thrift:"AuthMode,50,optional,PluginAuthMode" form:"auth_mode" json:"auth_mode,omitempty"`
...
type ToolParameter struct {
	...
	SubParameter []*ToolParameter `thrift:"SubParameter,5,default,list<ToolParameter>" form:"sub_params" json:"sub_params"`
}
...
type PluginToolInfo struct {
	...
	Name        string             `thrift:"Name,2" form:"name" json:"name"`
	Description string             `thrift:"Description,3" form:"description" json:"description"`
	Parameters  []*ToolParameter   `thrift:"Parameters,4,optional,list<ToolParameter>" form:"parameters" json:"parameters,omitempty"`
	...
	// operating mode
	RunMode *PluginRunMode `thrift:"RunMode,11,optional,PluginRunMode" form:"run_mode" json:"run_mode,omitempty"`
}
...
type BotConfig struct {
	// model
	Models []*ProductMaterial `thrift:"Models,1,optional,list<ProductMaterial>" form:"models" json:"models,omitempty"`
	// plugin
	Plugins []*ProductMaterial `thrift:"Plugins,2,optional,list<ProductMaterial>" form:"plugins" json:"plugins,omitempty"`
	// Knowledge Base
	Knowledges []*ProductMaterial `thrift:"Knowledges,3,optional,list<ProductMaterial>" form:"knowledges" json:"knowledges,omitempty"`
	// Workflow
	Workflows []*ProductMaterial `thrift:"Workflows,4,optional,list<ProductMaterial>" form:"workflows" json:"workflows,omitempty"`
	...
	BotVoices []*BotVoiceInfo `thrift:"BotVoices,9,optional,list<BotVoiceInfo>" form:"bot_voices" json:"bot_voices,omitempty"`
	...
	// Time Capsule Mode
	TimeCapsuleMode *TimeCapsuleMode `thrift:"TimeCapsuleMode,13,optional,TimeCapsuleMode" form:"time_capsule_mode" json:"time_capsule_mode,omitempty"`
	// File box mode
	FileboxMode *FileboxInfoMode `thrift:"FileboxMode,14,optional,FileboxInfoMode" form:"filebox_mode" json:"filebox_mode,omitempty"`
...
type Conversation struct {
	...
	Snippets []string `thrift:"Snippets,1,optional,list<string>" form:"snippets" json:"snippets,omitempty"`
	// conversation title
	...
	AuditStatus *product_common.AuditStatus `thrift:"AuditStatus,5,optional,ProductDraftStatus" form:"audit_status" json:"audit_status,omitempty"`
	// opening statement
...
type BotExtraInfo struct {
	// publish platforms
	PublishPlatforms []*BotPublishPlatform `thrift:"PublishPlatforms,1,default,list<BotPublishPlatform>" form:"publish_platforms" json:"publish_platforms"`
	// user count
	UserCount int32 `thrift:"UserCount,2" form:"user_count" json:"user_count"`
	// public method
	PublishMode product_common.ProductPublishMode `thrift:"PublishMode,3,default,ProductPublishMode" form:"publish_mode" json:"publish_mode"`
	// Details page unique
	ConversationSnippets [][]string `thrift:"ConversationSnippets,4,optional,list<list<string>>" form:"conversation_snippets" json:"conversation_snippets,omitempty"`
	// configuration
	...
	Conversations []*Conversation `thrift:"Conversations,8,optional,list<Conversation>" form:"conversations" json:"conversations,omitempty"`
...
type WorkflowParameter struct {
	...
	InputType     product_common.InputType `thrift:"InputType,4,default,InputType" form:"input_type" json:"input_type"`
	SubParameters []*WorkflowParameter     `thrift:"SubParameters,5,default,list<WorkflowParameter>" form:"sub_parameters" json:"sub_parameters"`
	// If Type is an array, there is a subtype
	SubType product_common.InputType `thrift:"SubType,6,default,InputType" form:"sub_type" json:"sub_type"`
	...
	Format     *product_common.PluginParamTypeFormat `thrift:"Format,8,optional,PluginParamTypeFormat" form:"format" json:"format,omitempty"`
	FromNodeId *string                               `thrift:"FromNodeId,9,optional" form:"from_node_id" json:"from_node_id,omitempty"`
	FromOutput []string                              `thrift:"FromOutput,10,optional,list<string>" form:"from_output" json:"from_output,omitempty"`
...
type WorkflowNodeParam struct {
	InputParameters  []*WorkflowParameter   `thrift:"InputParameters,1,optional,list<WorkflowParameter>" form:"input_parameters" json:"input_parameters,omitempty"`
	TerminatePlan    *WorkflowTerminatePlan `thrift:"TerminatePlan,2,optional" form:"terminate_plan" json:"terminate_plan,omitempty"`
	OutpurParameters []*WorkflowParameter   `thrift:"OutpurParameters,3,optional,list<WorkflowParameter>" form:"output_parameters" json:"output_parameters,omitempty"`
}
...
type WorkflowNodeInfo struct {
	...
	NodeType  product_common.WorkflowNodeType `thrift:"NodeType,2,default,WorkflowNodeType" form:"node_type" json:"node_type"`
...
type WorkflowEntity struct {
	...
	Nodes               []*WorkflowNodeInfo `thrift:"Nodes,11,optional,list<WorkflowNodeInfo>" form:"nodes" json:"nodes,omitempty"`
...
type WorkflowGUIConfig struct {
	...
	MessageNodes []*WorkflowNodeInfo `thrift:"MessageNodes,3,optional,list<WorkflowNodeInfo>" form:"message_nodes" json:"message_nodes,omitempty"`
}
...
type WorkflowExtraInfo struct {
	RelatedWorkflows []*WorkflowEntity `thrift:"RelatedWorkflows,1,default,list<WorkflowEntity>" form:"related_workflows" json:"related_workflows"`
	...
	Nodes               []*WorkflowNodeInfo `thrift:"Nodes,5,optional,list<WorkflowNodeInfo>" form:"nodes" json:"nodes,omitempty"`
...
type SocialScenePlayerInfo struct {
	ID       int64                              `thrift:"ID,1" form:"id" json:"id,string"`
	Name     string                             `thrift:"Name,2" form:"name" json:"name"`
	RoleType product_common.SocialSceneRoleType `thrift:"RoleType,3,default,SocialSceneRoleType" form:"role_type" json:"role_type"`
}
...
type SocialSceneExtraInfo struct {
	// role
	Players []*SocialScenePlayerInfo `thrift:"Players,1,optional,list<SocialScenePlayerInfo>" form:"players" json:"players,omitempty"`
	...
	// publish_mode
	PublishMode product_common.ProductPublishMode `thrift:"PublishMode,4,default,ProductPublishMode" form:"publish_mode" json:"publish_mode"`
}
...
type ProjectExtraInfo struct {
	...
	PreviewTypes []product_common.UIPreviewType `thrift:"PreviewTypes,3,default,list<UIPreviewType>" form:"preview_types" json:"preview_types"`
	// user count
	...
	// publish platforms
	PublishPlatforms []*BotPublishPlatform `thrift:"PublishPlatforms,6,default,list<BotPublishPlatform>" form:"publish_platforms" json:"publish_platforms"`
...
type GetProductDetailRequest struct {
	...
	EntityType *product_common.ProductEntityType `thrift:"EntityType,2,optional,ProductEntityType" form:"entity_type" json:"entity_type,omitempty"`
...
type SKUInfo struct {
	ID int64 `thrift:"ID,1" form:"id" json:"id,string"`
	// to be abandoned
	Price           []*Price                       `thrift:"Price,2,default,list<Price>" form:"price" json:"price"`
	Description     string                         `thrift:"Description,3" form:"description" json:"description"`
	PriceV2         []*marketplace_common.Price    `thrift:"PriceV2,4,default,list<marketplace_common.Price>" form:"price_v2" json:"price_v2"`
...
type SellAttr struct {
	...
	Values      []*SellAttrValue `thrift:"Values,3,default,list<SellAttrValue>" form:"values" json:"values"`
}
...
type SellInfo struct {
	...
	Attr []*SellAttr        `thrift:"Attr,2,default,list<SellAttr>" form:"attr" json:"attr"`
...
type GetProductDetailData struct {
	...
	AuditStatus product_common.ProductDraftStatus `thrift:"AuditStatus,3,default,ProductDraftStatus" form:"audit_status" json:"audit_status"`
...
type GetUserFavoriteListV2Request struct {
	...
	EntityType *product_common.ProductEntityType `thrift:"EntityType,3,optional,ProductEntityType" json:"EntityType,omitempty" query:"entity_type"`
	SortType   product_common.SortType           `thrift:"SortType,4,required,SortType" json:"SortType,required" query:"sort_type,required"`
	// Search keyword,optional
	Keyword *string `thrift:"Keyword,5,optional" json:"Keyword,omitempty" query:"keyword"`
	// List page tab
	Source *product_common.FavoriteListSource `thrift:"Source,6,optional,FavoriteListSource" json:"Source,omitempty" query:"source"`
	...
	EntityTypes []product_common.ProductEntityType `thrift:"EntityTypes,10,optional,list<ProductEntityType>" json:"EntityTypes,omitempty" query:"entity_types"`
...
type GetUserFavoriteListDataV2 struct {
	FavoriteEntities []*product_common.FavoriteEntity `thrift:"FavoriteEntities,1,default,list<product_common.FavoriteEntity>" form:"favorite_entities" json:"favorite_entities"`
...
type UserTriggerConfig struct {
	TriggerEnabled TriggerEnable `thrift:"TriggerEnabled,1,default,TriggerEnable" form:"TriggerEnabled" json:"TriggerEnabled" query:"TriggerEnabled"`
}
...
type GetProductCategoryListRequest struct {
	EntityType product_common.ProductEntityType `thrift:"EntityType,1,default,ProductEntityType" json:"EntityType" query:"entity_type"`
...
type GetProductCategoryListData struct {
	EntityType product_common.ProductEntityType `thrift:"EntityType,1,required,ProductEntityType" form:"entity_type,required" json:"entity_type,required"`
	Categories []*ProductCategory               `thrift:"Categories,2,optional,list<ProductCategory>" form:"categories" json:"categories,omitempty"`
}
...
type ProductCallCountLimit struct {
	...
	CallCountLimitByUserLevel map[UserLevel]*ProductCallCountLimit `thrift:"call_count_limit_by_user_level,5,default,map<UserLevel:ProductCallCountLimit>" form:"call_count_limit_by_user_level" json:"call_count_limit_by_user_level" query:"call_count_limit_by_user_level"`
}
...
type ProductCallRateLimit struct {
	...
	CallRateLimitByUserLevel map[UserLevel]*ProductCallRateLimit `thrift:"call_rate_limit_by_user_level,2,default,map<UserLevel:ProductCallRateLimit>" form:"call_rate_limit_by_user_level" json:"call_rate_limit_by_user_level" query:"call_rate_limit_by_user_level"`
}
...
type GetProductCallInfoData struct {
	...
	// Payment level
	UserLevel UserLevel `thrift:"user_level,2,default,UserLevel" form:"user_level" json:"user_level" query:"user_level"`
