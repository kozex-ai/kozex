...
type MsgParticipantInfo struct {
	...
	Type         MsgParticipantType `thrift:"type,2,default,MsgParticipantType" form:"type" json:"type" query:"type"`
...
type SubmitToolOutputs struct {
	ToolCalls []*InterruptPlugin `thrift:"tool_calls,1,default,list<InterruptPlugin>" form:"tool_calls" json:"tool_calls" query:"tool_calls"`
}
...
type ChatMessageMetaInfo struct {
	Type ChatMessageMetaType `thrift:"type,1,default,ChatMessageMetaType" form:"type" json:"type" query:"type"`
...
type ChatMessage struct {
	...
	MentionList  []*MsgParticipantInfo `thrift:"mention_list,12,optional,list<MsgParticipantInfo>" form:"mention_list" json:"mention_list,omitempty" query:"mention_list"`
	...
	MetaInfos []*ChatMessageMetaInfo `thrift:"meta_infos,18,optional,list<ChatMessageMetaInfo>" form:"meta_infos" json:"meta_infos,omitempty" query:"meta_infos"`
	// Card Status
...
type GetMessageListRequest struct {
	...
	Scene     *common.Scene `thrift:"scene,7,optional,Scene" form:"scene" json:"scene,omitempty" query:"scene"`
	...
	InsertHistoryMessageList []string       `thrift:"insert_history_message_list,9,optional,list<string>" form:"insert_history_message_list" json:"insert_history_message_list,omitempty" query:"insert_history_message_list"`
	LoadDirection            *LoadDirection `thrift:"load_direction,10,optional,LoadDirection" form:"load_direction" json:"load_direction,omitempty" query:"load_direction"`
...
type GetMessageListResponse struct {
	MessageList []*ChatMessage `thrift:"message_list,1,required,list<ChatMessage>" form:"message_list,required" json:"message_list,required" query:"message_list,required"`
...
type DeleteMessageRequest struct {
	...
	Scene          *common.Scene `thrift:"scene,3,optional,Scene" form:"scene" json:"scene,omitempty" query:"scene"`
...
type BreakMessageRequest struct {
	...
	Scene     *common.Scene `thrift:"scene,5,optional,Scene" form:"scene" json:"scene,omitempty" query:"scene"`
}
...
type ListMessageApiResponse struct {
	Messages []*OpenMessageApi `thrift:"messages,1,optional,list<OpenMessageApi>" form:"data" json:"data,omitempty"`
...
type ListChatMessageApiResponse struct {
	Messages []*ChatV3MessageDetail `thrift:"Messages,1,optional,list<ChatV3MessageDetail>" form:"Messages" json:"Messages,omitempty" query:"Messages"`
	Code     int64                  `thrift:"code,253" form:"code" json:"code" query:"code"`
	Msg      string                 `thrift:"msg,254" form:"msg" json:"msg" query:"msg"`
