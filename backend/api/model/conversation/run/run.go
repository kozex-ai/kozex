...
type MixContentModel struct {
	ItemList   []*Item `thrift:"item_list,1,default,list<Item>" form:"item_list" json:"item_list" query:"item_list"`
	ReferItems []*Item `thrift:"refer_items,2,default,list<Item>" form:"refer_items" json:"refer_items" query:"refer_items"`
}
...
type AgentRunRequest struct {
	...
	// Explore the scene
	Scene *common.Scene `thrift:"scene,11,optional,Scene" form:"scene" json:"scene,omitempty" query:"scene"`
	...
	InsertHistoryMessageList []string                      `thrift:"insert_history_message_list,16,optional,list<string>" form:"insert_history_message_list" json:"insert_history_message_list,omitempty" query:"insert_history_message_list"`
	...
	MentionList              []*message.MsgParticipantInfo `thrift:"mention_list,19,optional,list<message.MsgParticipantInfo>" form:"mention_list" json:"mention_list,omitempty" query:"mention_list"`
	ToolList                 []*Tool                       `thrift:"toolList,20,optional,list<Tool>" form:"toolList" json:"toolList,omitempty" query:"toolList"`
	...
	DiffModeIdentifier *DiffModeIdentifier `thrift:"diff_mode_identifier,23,optional,DiffModeIdentifier" form:"diff_mode_identifier" json:"diff_mode_identifier,omitempty" query:"diff_mode_identifier"`
...
type ChatV3Request struct {
	...
	AdditionalMessages []*EnterMessage `thrift:"AdditionalMessages,5,optional,list<EnterMessage>" form:"additional_messages" json:"additional_messages,omitempty"`
...
type SubmitToolOutputs struct {
	ToolCalls []*InterruptPlugin `thrift:"ToolCalls,1,default,list<InterruptPlugin>" form:"tool_calls" json:"tool_calls"`
}
...
type InterruptRequireInfo struct {
	Infos []string `thrift:"infos,1,default,list<string>" form:"infos" json:"infos" query:"infos"`
}
