...
type ClearConversationHistoryRequest struct {
	...
	Scene          *common.Scene `thrift:"scene,2,optional,Scene" form:"scene" json:"scene,omitempty" query:"scene"`
...
type ClearConversationCtxRequest struct {
	...
	InsertHistoryMessageList []string `thrift:"insert_history_message_list,3,optional,list<string>" form:"insert_history_message_list" json:"insert_history_message_list,omitempty" query:"insert_history_message_list"`
}
...
type ListConversationData struct {
	Conversations []*ConversationData `thrift:"conversations,1,default,list<ConversationData>" form:"conversations" json:"conversations"`
