...
type LibraryResourceListRequest struct {
	...
	ResTypeFilter []common.ResType `thrift:"res_type_filter,2,optional,list<ResType>" form:"res_type_filter" json:"res_type_filter,omitempty" query:"res_type_filter"`
	// name
	...
	PublishStatusFilter *common.PublishStatus `thrift:"publish_status_filter,4,optional,PublishStatus" form:"publish_status_filter" json:"publish_status_filter,omitempty" query:"publish_status_filter"`
	// User's space ID
	...
	SearchKeys []string `thrift:"search_keys,10,optional,list<string>" form:"search_keys" json:"search_keys,omitempty" query:"search_keys"`
...
type LibraryResourceListResponse struct {
	...
	ResourceList []*common.ResourceInfo `thrift:"resource_list,3,default,list<common.ResourceInfo>" form:"resource_list" json:"resource_list" query:"resource_list"`
...
type ProjectResourceListResponse struct {
	Code           int64                          `thrift:"code,1" form:"code" json:"code" query:"code"`
	Msg            string                         `thrift:"msg,2" form:"msg" json:"msg" query:"msg"`
	ResourceGroups []*common.ProjectResourceGroup `thrift:"resource_groups,3,default,list<common.ProjectResourceGroup>" form:"resource_groups" json:"resource_groups" query:"resource_groups"`
	BaseResp       *base.BaseResp                 `thrift:"BaseResp,255,required" form:"BaseResp,required" json:"BaseResp,required" query:"BaseResp,required"`
}
...
type ResourceCopyDispatchRequest struct {
	...
	Scene common.ResourceCopyScene `thrift:"scene,1,default,ResourceCopyScene" form:"scene" json:"scene" query:"scene"`
	// The resource ID selected by the user to copy/move
	ResID   int64          `thrift:"res_id,2" form:"res_id" json:"res_id,string"`
	ResType common.ResType `thrift:"res_type,3,default,ResType" form:"res_type" json:"res_type" query:"res_type"`
	// Project ID
...
type ResourceCopyDispatchResponse struct {
	...
	FailedReasons []*common.ResourceCopyFailedReason `thrift:"failed_reasons,4,optional,list<common.ResourceCopyFailedReason>" form:"failed_reasons" json:"failed_reasons,omitempty" query:"failed_reasons"`
	BaseResp      *base.BaseResp                     `thrift:"BaseResp,255,required" form:"BaseResp,required" json:"BaseResp,required" query:"BaseResp,required"`
}
