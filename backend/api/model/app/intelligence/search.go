...
type GetDraftIntelligenceListRequest struct {
	...
	Status       []common.IntelligenceStatus     `thrift:"status,4,optional,list<IntelligenceStatus>" form:"status" json:"status,omitempty" query:"status"`
	Types        []common.IntelligenceType       `thrift:"types,5,optional,list<IntelligenceType>" form:"types" json:"types,omitempty" query:"types"`
	SearchScope  *SearchScope                    `thrift:"search_scope,6,optional,SearchScope" form:"search_scope" json:"search_scope,omitempty" query:"search_scope"`
	...
	OrderBy      *OrderBy                        `thrift:"order_by,100,optional,OrderBy" form:"order_by" json:"order_by,omitempty" query:"order_by"`
...
type IntelligencePublishInfo struct {
	...
	Connectors   []*common.ConnectorInfo `thrift:"connectors,3,default,list<common.ConnectorInfo>" form:"connectors" json:"connectors" query:"connectors"`
}
...
type OtherInfo struct {
	...
	BotMode BotMode `thrift:"bot_mode,2,default,BotMode" form:"bot_mode" json:"bot_mode" query:"bot_mode"`
}
...
type Intelligence struct {
	...
	// Agent Type
	Type common.IntelligenceType `thrift:"type,2,default,IntelligenceType" form:"type" json:"type" query:"type"`
...
type DraftIntelligenceListData struct {
	Intelligences []*IntelligenceData `thrift:"intelligences,1,default,list<IntelligenceData>" form:"intelligences" json:"intelligences" query:"intelligences"`
...
type GetDraftIntelligenceInfoRequest struct {
	...
	IntelligenceType common.IntelligenceType `thrift:"intelligence_type,2,default,IntelligenceType" form:"intelligence_type" json:"intelligence_type" query:"intelligence_type"`
...
type GetDraftIntelligenceInfoData struct {
	IntelligenceType common.IntelligenceType       `thrift:"intelligence_type,1,default,IntelligenceType" form:"intelligence_type" json:"intelligence_type" query:"intelligence_type"`
...
type GetUserRecentlyEditIntelligenceRequest struct {
	...
	Types []common.IntelligenceType `thrift:"types,2,optional,list<IntelligenceType>" form:"types" json:"types,omitempty" query:"types"`
	// Enterprise ID
...
type GetUserRecentlyEditIntelligenceData struct {
	IntelligenceInfoList []*IntelligenceData `thrift:"intelligence_info_list,1,default,list<IntelligenceData>" form:"intelligence_info_list" json:"intelligence_info_list" query:"intelligence_info_list"`
}
