...
type GetProjectPublishedConnectorResponse struct {
	Data     []*common.ConnectorInfo `thrift:"data,1,default,list<common.ConnectorInfo>" form:"data" json:"data" query:"data"`
...
type PublishConnectorListData struct {
	ConnectorList   []*PublishConnectorInfo `thrift:"connector_list,1,default,list<PublishConnectorInfo>" form:"connector_list" json:"connector_list" query:"connector_list"`
...
type PublishConnectorInfo struct {
	...
	// channel type
	ConnectorClassification ConnectorClassification `thrift:"connector_classification,6,required,ConnectorClassification" form:"connector_classification,required" json:"connector_classification,required" query:"connector_classification,required"`
	// configuration status
	ConfigStatus ConnectorConfigStatus `thrift:"config_status,7,required,ConnectorConfigStatus" form:"config_status,required" json:"config_status,required" query:"config_status,required"`
	// channel status
	ConnectorStatus ConnectorStatus `thrift:"connector_status,8,default,ConnectorStatus" form:"connector_status" json:"connector_status" query:"connector_status"`
	// binding type
	BindType ConnectorBindType `thrift:"bind_type,9,required,ConnectorBindType" form:"bind_type,required" json:"bind_type,required" query:"bind_type,required"`
	...
	// UI Options
	UIOptions []*UIOption `thrift:"UIOptions,18,optional,list<UIOption>" form:"UIOptions" json:"UIOptions,omitempty" query:"UIOptions"`
	...
	AuthStatus *UserAuthStatus `thrift:"auth_status,21,optional,UserAuthStatus" form:"auth_status" json:"auth_status,omitempty" query:"auth_status"`
...
type LastPublishInfo struct {
	...
	ConnectorIds  []int64 `thrift:"connector_ids,2,default,list<i64>" form:"connector_ids" json:"connector_ids,string" query:"connector_ids"`
...
type ConnectorUnionInfo struct {
	...
	ConnectorOptions []*ConnectorUnionInfoOption `thrift:"connector_options,5,required,list<ConnectorUnionInfoOption>" form:"connector_options,required" json:"connector_options,required" query:"connector_options,required"`
}
...
type ConnectorPublishConfig struct {
	...
	SelectedWorkflows []*SelectedWorkflow `thrift:"selected_workflows,1,default,list<SelectedWorkflow>" form:"selected_workflows" json:"selected_workflows" query:"selected_workflows"`
}
...
type GetPublishRecordListResponse struct {
	Data     []*PublishRecordDetail `thrift:"data,1,default,list<PublishRecordDetail>" form:"data" json:"data" query:"data"`
	Code     int64                  `thrift:"code,253" form:"code" json:"code" query:"code"`
	Msg      string                 `thrift:"msg,254" form:"msg" json:"msg" query:"msg"`
	BaseResp *base.BaseResp         `thrift:"BaseResp,255,optional" form:"-" json:"-" query:"-"`
}
...
type PublishRecordDetail struct {
	...
	// release status
	PublishStatus PublishRecordStatus `thrift:"publish_status,3,default,PublishRecordStatus" form:"publish_status" json:"publish_status" query:"publish_status"`
	...
	ConnectorPublishResult []*ConnectorPublishResult `thrift:"connector_publish_result,5,optional,list<ConnectorPublishResult>" form:"connector_publish_result" json:"connector_publish_result,omitempty" query:"connector_publish_result"`
...
type ConnectorPublishResult struct {
	...
	ConnectorPublishStatus ConnectorPublishStatus `thrift:"connector_publish_status,4,default,ConnectorPublishStatus" form:"connector_publish_status" json:"connector_publish_status" query:"connector_publish_status"`
...
type PublishRecordStatusDetail struct {
	...
	PackFailedDetail []*PackFailedDetail `thrift:"pack_failed_detail,1,optional,list<PackFailedDetail>" form:"pack_failed_detail" json:"pack_failed_detail,omitempty" query:"pack_failed_detail"`
}
...
type PackFailedDetail struct {
	...
	EntityType common.ResourceType `thrift:"entity_type,2,default,ResourceType" form:"entity_type" json:"entity_type" query:"entity_type"`
