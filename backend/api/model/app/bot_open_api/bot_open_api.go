...
type WorkspacePermission struct {
	WorkspaceIDList []string `thrift:"workspace_id_list,1,default,list<string>" form:"workspace_id_list" json:"workspace_id_list" query:"workspace_id_list"`
	PermissionList  []string `thrift:"permission_list,2,default,list<string>" form:"permission_list" json:"permission_list" query:"permission_list"`
}
...
type AccountPermission struct {
	PermissionList []string `thrift:"permission_list,1,default,list<string>" form:"permission_list" json:"permission_list" query:"permission_list"`
}
