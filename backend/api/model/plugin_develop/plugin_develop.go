...
type GetPlaygroundPluginListRequest struct {
	...
	PluginIds []string `thrift:"plugin_ids,6,default,list<string>" form:"plugin_ids" json:"plugin_ids"`
	...
	PluginTypes []int32 `thrift:"plugin_types,7,default,list<i32>" form:"plugin_types" json:"plugin_types"`
	// ignore
...
type GetPluginAPIsRequest struct {
	...
	APIIds []string `thrift:"api_ids,2,default,list<string>" form:"api_ids" json:"api_ids" query:"api_ids"`
	// page number
...
type GetPluginAPIsResponse struct {
	...
	APIInfo     []*common.PluginAPIInfo `thrift:"api_info,3,default,list<common.PluginAPIInfo>" form:"api_info" json:"api_info" query:"api_info"`
...
type GetUpdatedAPIsResponse struct {
	...
	CreatedAPINames []string `thrift:"created_api_names,3,default,list<string>" form:"created_api_names" json:"created_api_names" query:"created_api_names"`
	// Deleted tool name
	DeletedAPINames []string `thrift:"deleted_api_names,4,default,list<string>" form:"deleted_api_names" json:"deleted_api_names" query:"deleted_api_names"`
	// updated tool name
	UpdatedAPINames []string       `thrift:"updated_api_names,5,default,list<string>" form:"updated_api_names" json:"updated_api_names" query:"updated_api_names"`
	BaseResp        *base.BaseResp `thrift:"BaseResp,255,optional" form:"BaseResp" json:"BaseResp,omitempty" query:"BaseResp"`
}
...
type GetPluginInfoResponse struct {
	...
	// ignore
	PluginProductStatus common.ProductStatus `thrift:"plugin_product_status,9,default,ProductStatus" form:"plugin_product_status" json:"plugin_product_status" query:"plugin_product_status"`
	// ignore
	...
	// ignore
	CreationMethod common.CreationMethod `thrift:"creation_method,12,default,CreationMethod" form:"creation_method" json:"creation_method" query:"creation_method"`
	// ignore
	...
	// ignore
	PluginType common.PluginType `thrift:"plugin_type,15,default,PluginType" form:"plugin_type" json:"plugin_type" query:"plugin_type"`
	BaseResp   *base.BaseResp    `thrift:"BaseResp,255,optional" form:"BaseResp" json:"BaseResp,omitempty" query:"BaseResp"`
}
...
type RegisterPluginMetaRequest struct {
	...
	AuthType *common.AuthorizationType `thrift:"auth_type,5,optional,AuthorizationType" form:"auth_type" json:"auth_type,omitempty" query:"auth_type"`
	// When the sub-authorization type is api/token, the token parameter position
	Location *common.AuthorizationServiceLocation `thrift:"location,6,optional,AuthorizationServiceLocation" form:"location" json:"location,omitempty" query:"location"`
	...
	CommonParams map[common.ParameterLocation][]*common.CommonParamSchema `thrift:"common_params,11,optional,map<ParameterLocation:list<common.CommonParamSchema>>" form:"common_params" json:"common_params,omitempty" query:"common_params"`
	// ignore
	CreationMethod *common.CreationMethod `thrift:"creation_method,12,optional,CreationMethod" form:"creation_method" json:"creation_method,omitempty" query:"creation_method"`
	// ignore
	...
	// ignore
	PluginType *common.PluginType `thrift:"plugin_type,14,optional,PluginType" form:"plugin_type" json:"plugin_type,omitempty" query:"plugin_type"`
	// App ID
...
type UpdatePluginMetaRequest struct {
	...
	AuthType *common.AuthorizationType `thrift:"auth_type,6,optional,AuthorizationType" form:"auth_type" json:"auth_type,omitempty" query:"auth_type"`
	// When the sub-authorization type is api/token, the token parameter position
	Location *common.AuthorizationServiceLocation `thrift:"location,7,optional,AuthorizationServiceLocation" form:"location" json:"location,omitempty" query:"location"`
	// When the sub-authorization type is api/token, the token parameter key
...
type GetBotDefaultParamsRequest struct {
	...
	PluginReferrerScene    common.PluginReferrerScene `thrift:"plugin_referrer_scene,7,default,PluginReferrerScene" form:"plugin_referrer_scene" json:"plugin_referrer_scene" query:"plugin_referrer_scene"`
...
type GetBotDefaultParamsResponse struct {
	Code           int64                  `thrift:"code,1" form:"code" json:"code" query:"code"`
	Msg            string                 `thrift:"msg,2" form:"msg" json:"msg" query:"msg"`
	RequestParams  []*common.APIParameter `thrift:"request_params,3,default,list<common.APIParameter>" form:"request_params" json:"request_params" query:"request_params"`
	ResponseParams []*common.APIParameter `thrift:"response_params,4,default,list<common.APIParameter>" form:"response_params" json:"response_params" query:"response_params"`
...
type UpdateBotDefaultParamsRequest struct {
	...
	PluginID            int64                      `thrift:"plugin_id,4" form:"plugin_id" json:"plugin_id,string" query:"plugin_id"`
	APIName             string                     `thrift:"api_name,5" form:"api_name" json:"api_name" query:"api_name"`
	RequestParams       []*common.APIParameter     `thrift:"request_params,6,default,list<common.APIParameter>" form:"request_params" json:"request_params" query:"request_params"`
	ResponseParams      []*common.APIParameter     `thrift:"response_params,7,default,list<common.APIParameter>" form:"response_params" json:"response_params" query:"response_params"`
	...
	PluginReferrerScene common.PluginReferrerScene `thrift:"plugin_referrer_scene,9,default,PluginReferrerScene" form:"plugin_referrer_scene" json:"plugin_referrer_scene" query:"plugin_referrer_scene"`
...
type DeleteBotDefaultParamsRequest struct {
	...
	PluginReferrerScene common.PluginReferrerScene `thrift:"plugin_referrer_scene,8,default,PluginReferrerScene" form:"plugin_referrer_scene" json:"plugin_referrer_scene" query:"plugin_referrer_scene"`
	WorkflowID          string                     `thrift:"workflow_id,9" form:"workflow_id" json:"workflow_id" query:"workflow_id"`
...
type UpdateAPIRequest struct {
	...
	// http method of tool
	Method *common.APIMethod `thrift:"method,6,optional,APIMethod" form:"method" json:"method,omitempty" query:"method"`
	// request parameters of tool
	RequestParams []*common.APIParameter `thrift:"request_params,7,optional,list<common.APIParameter>" form:"request_params" json:"request_params,omitempty" query:"request_params"`
	// response parameters of tool
	ResponseParams []*common.APIParameter `thrift:"response_params,8,optional,list<common.APIParameter>" form:"response_params" json:"response_params,omitempty" query:"response_params"`
...
type CreateAPIRequest struct {
	...
	// http method of tool
	Method *common.APIMethod `thrift:"method,5,optional,APIMethod" form:"method" json:"method,omitempty" query:"method"`
	// ignore
...
type GetUserAuthorityRequest struct {
	...
	CreationMethod common.CreationMethod `thrift:"creation_method,2,required,CreationMethod" form:"creation_method,required" json:"creation_method,required"`
...
type GetOAuthStatusResponse struct {
	...
	Status common.OAuthStatus `thrift:"status,2,default,OAuthStatus" form:"status" json:"status" query:"status"`
...
type GetPluginPublishHistoryResponse struct {
	...
	Msg  string `thrift:"msg,2" form:"msg" json:"msg" query:"msg"`
	// reverse time
	PluginPublishInfoList []*common.PluginPublishInfo `thrift:"plugin_publish_info_list,3,default,list<common.PluginPublishInfo>" form:"plugin_publish_info_list" json:"plugin_publish_info_list" query:"plugin_publish_info_list"`
...
type DebugAPIRequest struct {
	...
	// ignore
	Operation common.DebugOperation `thrift:"operation,4,required,DebugOperation" form:"operation,required" json:"operation,required" query:"operation,required"`
	// ignore
...
type DebugAPIResponse struct {
	...
	Msg  string `thrift:"msg,2" form:"msg" json:"msg" query:"msg"`
	// response parameters
	ResponseParams []*common.APIParameter `thrift:"response_params,3,default,list<common.APIParameter>" form:"response_params" json:"response_params" query:"response_params"`
...
type RegisterPluginRequest struct {
	...
	// ignore
	PluginType *common.PluginType `thrift:"plugin_type,7,optional,PluginType" form:"plugin_type" json:"plugin_type,omitempty" query:"plugin_type"`
...
type GetDevPluginListRequest struct {
	Status    []common.PluginStatus `thrift:"status,1,optional,list<PluginStatus>" form:"status" json:"status,omitempty" query:"status"`
	...
	ScopeType *common.ScopeType     `thrift:"scope_type,6,optional,ScopeType" form:"scope_type" json:"scope_type,omitempty" query:"scope_type"`
	OrderBy   *common.OrderBy       `thrift:"order_by,7,optional,OrderBy" form:"order_by" json:"order_by,omitempty" query:"order_by"`
	...
	PluginTypeForFilter *common.PluginTypeForFilter `thrift:"plugin_type_for_filter,10,optional,PluginTypeForFilter" form:"plugin_type_for_filter" json:"plugin_type_for_filter,omitempty" query:"plugin_type_for_filter"`
	ProjectID           int64                       `thrift:"project_id,11" form:"project_id" json:"project_id,string"`
	// plugin id list
	PluginIds []int64    `thrift:"plugin_ids,12,default,list<i64>" form:"plugin_ids" json:"plugin_ids"`
	Base      *base.Base `thrift:"Base,255,optional" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
type GetDevPluginListResponse struct {
	...
	Msg        string                            `thrift:"msg,2" form:"msg" json:"msg" query:"msg"`
	PluginList []*common.PluginInfoForPlayground `thrift:"plugin_list,3,default,list<common.PluginInfoForPlayground>" form:"plugin_list" json:"plugin_list" query:"plugin_list"`
...
type Convert2OpenAPIResponse struct {
	...
	// protocol type
	PluginDataFormat *common.PluginDataFormat `thrift:"plugin_data_format,5,optional,PluginDataFormat" form:"plugin_data_format" json:"plugin_data_format,omitempty" query:"plugin_data_format"`
	// ignore
	DuplicateAPIInfos []*common.DuplicateAPIInfo `thrift:"duplicate_api_infos,6,default,list<common.DuplicateAPIInfo>" form:"duplicate_api_infos" json:"duplicate_api_infos" query:"duplicate_api_infos"`
	// BaseResp.StatusCode
...
type BatchCreateAPIRequest struct {
	...
	// ignore
	PathsToReplace []*common.PluginAPIInfo `thrift:"paths_to_replace,7,optional,list<common.PluginAPIInfo>" form:"paths_to_replace" json:"paths_to_replace,omitempty"`
	// ignore
...
type BatchCreateAPIResponse struct {
	...
	PathsDuplicated []*common.PluginAPIInfo `thrift:"paths_duplicated,3,optional,list<common.PluginAPIInfo>" form:"paths_duplicated" json:"paths_duplicated,omitempty" query:"paths_duplicated"`
	PathsCreated    []*common.PluginAPIInfo `thrift:"paths_created,4,optional,list<common.PluginAPIInfo>" form:"paths_created" json:"paths_created,omitempty" query:"paths_created"`
	EditVersion     int32                   `thrift:"edit_version,5" form:"edit_version" json:"edit_version" query:"edit_version"`
	// BaseResp.StatusCode
...
type GetQueriedOAuthPluginListResponse struct {
	OauthPluginList []*OAuthPluginInfo `thrift:"oauth_plugin_list,1,default,list<OAuthPluginInfo>" form:"oauth_plugin_list" json:"oauth_plugin_list" query:"oauth_plugin_list"`
	Code            int64              `thrift:"code,253" form:"code" json:"code" query:"code"`
	Msg             string             `thrift:"msg,254" form:"msg" json:"msg" query:"msg"`
	BaseResp        *base.BaseResp     `thrift:"BaseResp,255,required" form:"BaseResp,required" json:"BaseResp,required" query:"BaseResp,required"`
}
