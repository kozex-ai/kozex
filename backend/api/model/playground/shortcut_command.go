...
type ShortcutStruct struct {
	...
	ShortcutSort []string `thrift:"shortcut_sort,16,optional,list<string>" form:"shortcut_sort" json:"shortcut_sort,omitempty" query:"shortcut_sort"`
	// Quick command content list
	ShortcutList []*ShortcutCommand `thrift:"shortcut_list,17,optional,list<ShortcutCommand>" form:"shortcut_list" json:"shortcut_list,omitempty" query:"shortcut_list"`
}
...
type ShortcutCommand struct {
	...
	// Send type
	SendType SendType `thrift:"send_type,6,default,SendType" form:"send_type" json:"send_type" query:"send_type"`
	// Use tool type
	ToolType      ToolType `thrift:"tool_type,7,default,ToolType" form:"tool_type" json:"tool_type" query:"tool_type"`
	...
	// Panel parameters
	ComponentsList []*Components `thrift:"components_list,12,default,list<Components>" form:"components_list" json:"components_list" query:"components_list"`
	// Form schema
	...
	PluginFrom  *bot_common.PluginFrom `thrift:"plugin_from,23,optional,PluginFrom" form:"plugin_from" json:"plugin_from,omitempty" query:"plugin_from"`
}
...
type Components struct {
	...
	InputType   InputType `thrift:"input_type,3,default,InputType" form:"input_type" json:"input_type" query:"input_type"`
	...
	Options      []string      `thrift:"options,5,default,list<string>" form:"options" json:"options" query:"options"`
	...
	UploadOptions []InputType `thrift:"upload_options,8,default,list<InputType>" form:"upload_options" json:"upload_options" query:"upload_options"`
}
...
type DefaultValue struct {
	...
	Type  InputType `thrift:"type,2,default,InputType" form:"type" json:"type" query:"type"`
}
...
type ToolInfo struct {
	...
	ToolParamsList []*ToolParams `thrift:"tool_params_list,2,default,list<ToolParams>" form:"tool_params_list" json:"tool_params_list" query:"tool_params_list"`
}
