...
type GetOfficialPromptResourceListResponse struct {
	PromptResourceList []*PromptResource `thrift:"PromptResourceList,1,default,list<PromptResource>" form:"data" json:"data"`
...
type SyncPromptResourceToEsRequest struct {
	...
	PromptResourceIDList []int64    `thrift:"PromptResourceIDList,2,optional,list<i64>" form:"PromptResourceIDList" json:"PromptResourceIDList,omitempty" query:"PromptResourceIDList"`
	SpaceIDList          []int64    `thrift:"SpaceIDList,3,optional,list<i64>" form:"SpaceIDList" json:"SpaceIDList,omitempty" query:"SpaceIDList"`
...
type DisplayResourceInfo struct {
	...
	PublishStatus *ResourcePublishStatus `thrift:"PublishStatus,20,optional,ResourcePublishStatus" form:"PublishStatus" json:"PublishStatus,omitempty" query:"PublishStatus"`
